...
// אחד ("איסוף והצגה למחלק העופות") מבצע את שניהם יחד בעסקה אחת — גם אם הכמות
...
/**
 * היסטוריה כרונולוגית מלאה של כל אירועי האיסוף של לקוח (טבלת redemptions —
 * מעודכנת גם מאיסוף רגיל וגם מעריכה ידנית של "נמשך בפועל", ראו
...
/**
 * איסוף משולב לזמן חלוקה שלם: כמות זכרים + כמות נקבות (כל אחת יכולה להיות 0),
